...
connection.select('_Language', '*', { LanguageId: '1..3' }, (err, results) => {
...
connection.delete('_Language', { LanguageSign: 'UY' }, (err, results) => {
